    ...
    private void obtenerImdbId(String tmdbId, Movie movie) {
        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                // Notificar al adapter que el item ha cambiado si necesario
                // Esto dependerá de cómo está implementado el adapter
                // Por ejemplo, si la lista se actualiza en la llamada principal, no es necesario aquí
            }
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                ...
                movie.setId("ID no disponible");
                // Similar a above, notificar al adapter si necesario
            }
        });
    }
